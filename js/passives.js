...
const PASSIVE_DATA = {
  ...
  dio_boss:         { name:'吸血鬼の力', type:'regen', desc:'毎T HP3%回復', value:0.03 },
  kokushibo:        { name:'上弦の再生', type:'regen', desc:'毎T HP3%回復', value:0.03 },
  ...
  father_boss:      { name:'魂の集合体', type:'regen', desc:'毎T HP3%回復', value:0.03 },
  // ── MIDBOSS ───────────────────────────────────────────
  ...
  ulquiorra_mb:     { name:'虚の再生',                type:'regen',               desc:'毎T HP3%回復', value:0.03 },
  grimmjow_mb:      { name:'戦闘狂',                  type:'low_hp_atk',          desc:'HP50%↓ 攻↑（2T）', threshold:0.5, buff:'atk_up', turns:2 },
  akaza_mb:         { name:'鬼の再生',                type:'regen',               desc:'毎T HP3%回復', value:0.03 },
  doma_mb:          { name:'氷の抱擁',                type:'status_immune',       desc:'燃焼・凍結無効', targets:['burn','freeze'] },
  mahito_mb:        { name:'無為転変',                type:'regen',               desc:'毎T HP3%回復', value:0.03 },
  ...
  zeref_mb:         { name:'死の呪い',                type:'regen',               desc:'毎T HP3%回復', value:0.03 },
  chrollo_mb:       { name:'盗んだ能力',              type:'atk_boost',           desc:'攻撃力常時+10%', value:0.10 },
  neferpitou_mb:    { name:'王への忠誠', type:'regen', desc:'毎T HP3%回復', value:0.03 },
