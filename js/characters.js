...
const BOSS_DATA = [
  ...
  { id:'aizen_boss',         name:'藍染惣右介〈完全体〉',emoji:'💠',maxHp:730, isBoss:true, color:'#886600', origin:'BLEACH', skillIds:['b_aizen_kyoka','b_aizen_light','b_aizen_hiryu','b_aizen_transcend','b_aizen_shield'], chargeSkillId:'b_aizen_hogyoku', intro:'「これから…私が、天に立つ。」' },
...
const ENEMY_SKILL_DATA = {
  ...
  b_aizen_hiryu:      { name:'破道の八十八・飛竜撃賊震天雷炮', icon:'⚡', power:35, type:'magic', target:'all', hits:1, animation:'thunder' },
