...
// ============================================================
const ENEMY_DATA = [
  { id:'demon_warrior', name:'魔族の戦士',   emoji:'👹', role:'attacker', maxHp:90, color:'#880000', skillIds:['e_slash','e_dark_wave','e_power_up','e_slash'] },
  { id:'frieza_soldier',name:'フリーザ兵',   emoji:'👽', role:'attacker', maxHp:83, color:'#cc44cc', skillIds:['e_beam','e_slash','e_power_up','e_beam'] },
  { id:'mech',          name:'機械兵器',     emoji:'🤖', role:'attacker', maxHp:105, color:'#448888', skillIds:['e_missile','e_laser','e_repair','e_missile','e_shield_self'], chargeSkillId:'e_charge_cannon' },
  { id:'dragon_enemy',  name:'ドラゴン',     emoji:'🐲', role:'attacker', maxHp:108, color:'#336600', skillIds:['e_fire_breath','e_tail_sweep','e_roar','e_fire_breath'] },
  { id:'upper_demon',   name:'上弦の鬼',     emoji:'👺', role:'support',  maxHp:98, color:'#660022', skillIds:['e_supp_heal','e_curse','e_team_buff','e_dark_wave','e_supp_shield'] },
  { id:'zombie',        name:'ゾンビ',       emoji:'🧟', role:'support',  maxHp:87, color:'#446633', skillIds:['e_supp_heal','e_curse','e_team_buff','e_slash','e_supp_shield'] },
  { id:'death_knight',  name:'死霊騎士',     emoji:'💀', role:'support',  maxHp:93, color:'#334455', skillIds:['e_supp_heal','e_curse','e_team_buff','e_dark_wave','e_supp_shield'] },
  { id:'orc_general',   name:'オーク将軍',   emoji:'🐗', role:'attacker', maxHp:113, color:'#664422', skillIds:['e_heavy_blow','e_war_cry','e_slash','e_heavy_blow','e_shield_self'] },
  { id:'cursed_spirit', name:'呪霊',         emoji:'👻', role:'support',  maxHp:90, color:'#442255', skillIds:['e_supp_heal','e_curse','e_team_buff','e_dark_wave','e_supp_shield'] },
  { id:'titan',         name:'巨人',         emoji:'🦴', role:'attacker', maxHp:120, color:'#886644', skillIds:['e_heavy_blow','e_tail_sweep','e_roar','e_heavy_blow'] },
  { id:'goblin_king',   name:'ゴブリン将軍', emoji:'👺', role:'support',  maxHp:87, color:'#336622', skillIds:['e_supp_heal','e_war_cry','e_team_buff','e_slash','e_supp_shield'] },
  { id:'vampire',       name:'吸血鬼',       emoji:'🧛', role:'support',  maxHp:95, color:'#550022', skillIds:['e_supp_heal','e_curse','e_team_buff','e_blood_art','e_supp_shield'] },
  ...
  { id:'ice_spirit',    name:'氷霊',         emoji:'💎', role:'support',  maxHp:87, color:'#aaddff', skillIds:['e_supp_heal','e_slow','e_team_buff','e_ice_shard','e_supp_shield'] },
  { id:'thunder_beast', name:'雷神獣',       emoji:'🐯', role:'attacker', maxHp:98, color:'#aacc00', skillIds:['e_thunder_fang','e_laser','e_roar','e_thunder_fang'] },
  { id:'sea_serpent',   name:'海蛇魔神',     emoji:'🐍', role:'attacker', maxHp:102, color:'#003388', skillIds:['e_water_blast','e_tail_sweep','e_poison_bite','e_water_blast'] },
  { id:'light_guardian',name:'光の守護者',   emoji:'👼', role:'support',  maxHp:93, color:'#ffeeaa', skillIds:['e_supp_heal','e_light_bind','e_light_guard','e_holy_strike','e_supp_shield'] },
  { id:'armored_curse', name:'呪いの鎧',     emoji:'🛡️', role:'attacker', maxHp:117, color:'#334466', skillIds:['e_heavy_blow','e_dark_wave','e_war_cry','e_heavy_blow','e_shield_self'] },
  { id:'phantom_wolf',  name:'幻狼王',       emoji:'🐺', role:'attacker', maxHp:93, color:'#557788', skillIds:['e_slash','e_roar','e_power_up','e_heavy_blow'] },
  { id:'mech_dragon',   name:'機甲龍',       emoji:'🦾', role:'attacker', maxHp:108, color:'#335577', skillIds:['e_thunder_fang','e_laser','e_missile','e_thunder_fang'], chargeSkillId:'e_charge_cannon' },
  { id:'dark_elf',      name:'闇エルフの弓兵',emoji:'🧝', role:'attacker', maxHp:93, color:'#223344', skillIds:['e_dark_arrow','e_dark_wave','e_power_up','e_dark_arrow'] },
  { id:'ancient_golem', name:'古代ゴーレム', emoji:'🗿', role:'attacker', maxHp:128, color:'#776655', skillIds:['e_stone_fist','e_heavy_blow','e_repair','e_stone_fist','e_shield_self'] },
  { id:'dragon_warrior',name:'竜人族の戦士', emoji:'🐲', role:'attacker', maxHp:102, color:'#554400', skillIds:['e_fire_slash','e_fire_breath','e_slash','e_fire_slash'] },
  { id:'sea_king',      name:'深海の王者',   emoji:'🦈', role:'attacker', maxHp:108, color:'#003366', skillIds:['e_water_breath','e_water_blast','e_tail_sweep','e_water_breath'] },
  { id:'demon_beast',   name:'呪いの魔獣',   emoji:'🐺', role:'attacker', maxHp:98, color:'#332233', skillIds:['e_demon_claws','e_curse','e_dark_wave','e_demon_claws'] },
  { id:'shadow_assassin', name:'影の刺客',     emoji:'🥷', role:'attacker', maxHp:96, color:'#223344', skillIds:['e_shadow_stab','e_slash','e_dark_wave','e_shadow_stab'] },
  { id:'bone_dragon_e',   name:'骸骨龍',       emoji:'💀', role:'attacker', maxHp:113, color:'#445566', skillIds:['e_bone_blast','e_tail_sweep','e_roar','e_bone_blast'] },
  { id:'lava_golem',      name:'溶岩ゴーレム', emoji:'🌋', role:'attacker', maxHp:123, color:'#993300', skillIds:['e_lava_fist','e_heavy_blow','e_fire_breath','e_lava_fist'], chargeSkillId:'e_charge_eruption' },
  { id:'thunder_knight_e',name:'雷霆騎士',     emoji:'⚡', role:'attacker', maxHp:105, color:'#886600', skillIds:['e_thunder_lance','e_slash','e_war_cry','e_thunder_lance'] },
  { id:'undead_mage',     name:'不死の魔導士', emoji:'💀', role:'support',  maxHp:90, color:'#334466', skillIds:['e_supp_heal','e_curse','e_team_buff','e_dark_wave','e_supp_shield'] },
  { id:'hell_hound',      name:'地獄犬',       emoji:'🐕', role:'attacker', maxHp:93, color:'#661100', skillIds:['e_hellfire_e','e_slash','e_poison_bite','e_hellfire_e'] },
  { id:'crystal_guardian',name:'水晶の守護者', emoji:'💎', role:'attacker', maxHp:117, color:'#88aacc', skillIds:['e_crystal_spike','e_heavy_blow','e_repair','e_crystal_spike'] },
  { id:'wind_elemental',  name:'風の精霊',     emoji:'💨', role:'support',  maxHp:87, color:'#aaccaa', skillIds:['e_supp_heal','e_roar','e_team_buff','e_tail_sweep','e_supp_shield'] },
  { id:'mirror_demon',    name:'鏡の魔人',     emoji:'🪞', role:'support',  maxHp:98, color:'#556677', skillIds:['e_supp_heal','e_curse','e_team_buff','e_dark_wave','e_supp_shield'] },
  { id:'poison_toad_e',   name:'毒ガエル王',   emoji:'🐸', role:'attacker', maxHp:90, color:'#336622', skillIds:['e_venom_spit','e_poison_bite','e_regen','e_venom_spit'] },
  { id:'dark_shaman_e',   name:'闇のシャーマン',emoji:'🧙', role:'support', maxHp:93, color:'#442255', skillIds:['e_supp_heal','e_curse','e_team_buff','e_dark_wave','e_supp_shield'] },
  { id:'ice_titan',       name:'氷の巨人',     emoji:'🧊', role:'attacker', maxHp:120, color:'#88aaff', skillIds:['e_blizzard_e','e_heavy_blow','e_slow','e_blizzard_e'] },
  { id:'death_reaper',    name:'死神',         emoji:'💀', role:'attacker', maxHp:102, color:'#222233', skillIds:['e_death_scythe','e_curse','e_dark_wave','e_death_scythe'] },
  { id:'chaos_wyrm',      name:'混沌の竜',     emoji:'🐉', role:'attacker', maxHp:111, color:'#440055', skillIds:['e_chaos_breath_e','e_tail_sweep','e_roar','e_chaos_breath_e'], chargeSkillId:'e_charge_abyss' },
  { id:'soul_eater_e',    name:'魂喰いの怪物', emoji:'👻', role:'attacker', maxHp:99, color:'#332244', skillIds:['e_soul_drain','e_dark_wave','e_curse','e_soul_drain'] },
  { id:'iron_golem',      name:'鉄のゴーレム', emoji:'🗿', role:'attacker', maxHp:128, color:'#556655', skillIds:['e_iron_pound','e_heavy_blow','e_repair','e_iron_pound','e_shield_self'] },
  { id:'frost_phoenix',   name:'霜の鳳',       emoji:'🦅', role:'attacker', maxHp:102, color:'#99ccff', skillIds:['e_frost_blast','e_ice_shard','e_blizzard_e','e_frost_blast'] },
  { id:'venom_serpent',   name:'毒蛇の魔神',   emoji:'🐍', role:'attacker', maxHp:98, color:'#336644', skillIds:['e_venom_coil','e_poison_bite','e_water_blast','e_venom_coil'] },
  { id:'abyss_knight',    name:'深淵騎士',     emoji:'🛡️', role:'attacker', maxHp:108, color:'#221133', skillIds:['e_abyss_slash','e_dark_wave','e_heavy_blow','e_abyss_slash','e_shield_self'] },
  { id:'storm_giant_e',   name:'嵐の巨人',     emoji:'🌪️', role:'attacker', maxHp:123, color:'#335566', skillIds:['e_tail_sweep','e_heavy_blow','e_roar','e_tail_sweep'] },
  { id:'plague_doctor_e', name:'疫病医',       emoji:'🎭', role:'support',  maxHp:90, color:'#334433', skillIds:['e_supp_heal','e_curse','e_team_buff','e_plague_cloud','e_supp_shield'] },
  { id:'shadow_clone_e',  name:'影の分身',     emoji:'🌑', role:'attacker', maxHp:87, color:'#333344', skillIds:['e_shadow_strike','e_slash','e_dark_wave','e_shadow_strike'] },
  { id:'blood_demon_e',   name:'血の悪魔',     emoji:'🩸', role:'support',  maxHp:102, color:'#550011', skillIds:['e_supp_heal','e_curse','e_team_buff','e_blood_art_2','e_supp_shield'] },
  { id:'earth_colossus',  name:'大地の巨神',   emoji:'🗻', role:'attacker', maxHp:132, color:'#664433', skillIds:['e_earth_smash','e_heavy_blow','e_roar','e_earth_smash'], chargeSkillId:'e_charge_eruption' },
  { id:'celestial_beast', name:'天上の魔獣',   emoji:'✨', role:'attacker', maxHp:108, color:'#cccc66', skillIds:['e_holy_strike','e_light_bind','e_roar','e_holy_strike'] },
  { id:'void_wraith',     name:'虚無の怨霊',   emoji:'👁️', role:'support',  maxHp:93, color:'#221122', skillIds:['e_supp_heal','e_curse','e_team_buff','e_void_drain','e_supp_shield'] },
  { id:'demon_general_e', name:'魔軍将軍',     emoji:'👺', role:'attacker', maxHp:117, color:'#440022', skillIds:['e_demon_blade','e_dark_wave','e_power_up','e_demon_blade'] },
  { id:'ancient_vampire', name:'古代吸血鬼',   emoji:'🧛', role:'support',  maxHp:105, color:'#330011', skillIds:['e_supp_heal','e_curse','e_team_buff','e_blood_art','e_supp_shield'] },
  { id:'berserker_orc',   name:'狂戦士オーク', emoji:'🐗', role:'attacker', maxHp:120, color:'#554422', skillIds:['e_heavy_blow','e_war_cry','e_slash','e_heavy_blow'] },
  { id:'cursed_swordsman',name:'呪われた剣士', emoji:'⚔️', role:'attacker', maxHp:99, color:'#332233', skillIds:['e_cursed_slash','e_dark_wave','e_slash','e_cursed_slash'] }
];
...
const BOSS_DATA = [
  ...
  { id:'boros',         name:'ボロス〈解放形態〉',      emoji:'👾', maxHp:690, isBoss:true, color:'#440088', origin:'ワンパンマン', skillIds:['b_collapsing_star','b_meteoric_burst','b_regen_boss'], chargeSkillId:'b_galaxy_burst', intro:'「ようやく出会えた…俺の全力を受け止められる者に！」' },
  ...
  { id:'aizen_boss',         name:'藍染惣右介〈完全体〉',emoji:'💠',maxHp:730, isBoss:true, color:'#886600', origin:'BLEACH', skillIds:['b_aizen_kyoka','b_aizen_light','b_aizen_transcend','b_aizen_shield'], chargeSkillId:'b_aizen_hogyoku', intro:'「これから…私が、天に立つ。」' },
  ...
  { id:'pucci_boss',         name:'プッチ神父〈MadeInHeaven〉',    emoji:'⛪', maxHp:760, isBoss:true, color:'#003355', origin:'ジョジョの奇妙な冒険', skillIds:['b_pucci_disc','b_pucci_made','b_pucci_time'], chargeSkillId:'b_pucci_heaven',       intro:'「天国に至る方法がわかった…DIOよ、僕たちは神になれる！」' },
...
const ENEMY_SKILL_DATA = {
  ...
  e_slash:        { name:'斬撃',         icon:'⚔️', power:14,  type:'physical', target:'single', hits:1, animation:'slash' },
  e_dark_wave:    { name:'暗黒波',       icon:'🌑', power:18,  type:'magic',    target:'single', hits:1, animation:'dark' },
  e_power_up:     { name:'戦気高揚',     icon:'⬆️', power:0,   type:'support',  target:'self',   effect:'atk_up', effectChance:1, effectTurns:3, animation:'buff' },
  e_beam:         { name:'デスビーム',   icon:'💥', power:17,  type:'magic',    target:'single', hits:1, animation:'beam' },
  e_missile:      { name:'ミサイル',     icon:'🚀', power:26, type:'physical', target:'single', hits:1, animation:'slash' },
  e_laser:        { name:'レーザー',     icon:'🔴', power:20, type:'magic',    target:'all',    hits:1, animation:'beam' },
  e_repair:       { name:'自己修復',     icon:'🔧', power:0,   type:'heal',     target:'self',   healPower:20,  animation:'heal' },
  e_fire_breath:  { name:'ファイアブレス',icon:'🔥',power:17,  type:'magic',    target:'all',    effect:'burn', effectChance:1, effectTurns:2, animation:'explosion' },
  e_tail_sweep:   { name:'テールスイープ',icon:'💨',power:17,  type:'physical', target:'all',    hits:1, animation:'slash' },
  e_roar:         { name:'咆哮',         icon:'📢', power:0,   type:'support',  target:'all',    effect:'def_down', effectChance:1, effectTurns:2, animation:'dark' },
  e_blood_art:    { name:'血鬼術',       icon:'🩸', power:21, type:'magic',    target:'single', hits:1, animation:'dark' },
  e_regen:        { name:'再生',         icon:'💚', power:0,   type:'support',  target:'self',   effect:'regen', effectChance:1, effectTurns:2, animation:'heal' },
  e_poison_bite:  { name:'毒牙',         icon:'☠️', power:11,  type:'physical', target:'single', effect:'poison', effectChance:1, effectTurns:3, animation:'slash' },
  e_curse:        { name:'呪い',         icon:'🔮', power:0,   type:'support',  target:'all',    effect:'curse', effectChance:1, effectTurns:2, animation:'dark' },
  e_heavy_blow:   { name:'強打',         icon:'💪', power:23, type:'physical', target:'single', hits:1, animation:'punch' },
  e_war_cry:      { name:'雄叫び',       icon:'📣', power:0,   type:'support',  target:'self',   effect:'atk_up', effectChance:1, effectTurns:2, animation:'buff' },
  e_ice_shard:    { name:'氷の矢',       icon:'🧊', power:18,  type:'magic',    target:'single', hits:1, animation:'ice', effect:'freeze', effectChance:1, effectTurns:1 },
  e_blizzard_e:   { name:'吹雪',         icon:'🌨️', power:14,  type:'magic',    target:'all',    effect:'freeze', effectChance:1, effectTurns:2, animation:'ice' },
  e_slow:         { name:'スロウ',       icon:'🐢', power:0,   type:'support',  target:'all',    effect:'freeze', effectChance:1, effectTurns:2, animation:'ice' },
  e_thunder_fang: { name:'雷牙',         icon:'⚡', power:16,  type:'magic',    target:'single', effect:'paralyze', effectChance:1, effectTurns:2, animation:'thunder' },
  e_water_blast:  { name:'水撃',         icon:'💧', power:18,  type:'magic',    target:'single', hits:1, animation:'ice' },
  e_holy_strike:  { name:'聖撃',         icon:'✨', power:18,  type:'magic',    target:'single', hits:1, animation:'beam' },
  e_light_bind:   { name:'光の拘束',     icon:'🔗', power:0,   type:'support',  target:'single', effect:'stun', effectChance:1, effectTurns:1, animation:'buff' },
  e_dark_arrow:   { name:'闇の矢',       icon:'🌑', power:17,  type:'magic',    target:'single', hits:1, animation:'dark' },
  e_stone_fist:   { name:'石の拳',       icon:'🪨', power:24, type:'physical', target:'single', hits:1, animation:'punch', selfShieldPower:20 },
  e_fire_slash:   { name:'炎斬り',       icon:'🔥', power:15,  type:'physical', target:'single', hits:1, animation:'explosion', effect:'burn', effectChance:1, effectTurns:2 },
  e_water_breath: { name:'水の息吹',     icon:'🌊', power:19,  type:'magic',    target:'all',    hits:1, animation:'ice' },
  e_demon_claws:  { name:'魔獣の爪',     icon:'🐾', power:25, type:'physical', target:'single', hits:1, animation:'slash', effect:'poison', effectChance:1, effectTurns:2 },
  ...
  e_shadow_stab:   { name:'影の刺突',     icon:'🌑', power:19,  type:'physical', target:'single', hits:1, animation:'slash' },
  e_bone_blast:    { name:'骨の爆発',     icon:'💀', power:15,  type:'physical', target:'all',    hits:1, animation:'explosion' },
  e_lava_fist:     { name:'溶岩拳',       icon:'🌋', power:19,  type:'magic',    target:'single', hits:1, animation:'explosion', effect:'burn', effectChance:1, effectTurns:2 },
  e_thunder_lance: { name:'雷の槍',       icon:'⚡', power:17,  type:'magic',    target:'single', hits:1, animation:'thunder',   effect:'paralyze', effectChance:1, effectTurns:2 },
  e_hellfire_e:    { name:'地獄の炎',     icon:'🔥', power:15,  type:'magic',    target:'all',    hits:1, animation:'explosion', effect:'burn', effectChance:1, effectTurns:2 },
  e_crystal_spike: { name:'水晶の刺',     icon:'💎', power:18,  type:'physical', target:'single', hits:1, animation:'slash', selfShieldPower:25 },
  e_venom_spit:    { name:'毒液',         icon:'☠️', power:12,  type:'physical', target:'single', hits:1, animation:'slash',     effect:'poison', effectChance:1, effectTurns:3 },
  e_death_scythe:  { name:'死神の鎌',     icon:'💀', power:23, type:'physical', target:'single', hits:1, animation:'slash' },
  e_chaos_breath_e:{ name:'混沌の息吹',   icon:'🌀', power:19,  type:'magic',    target:'all',    hits:1, animation:'dark' },
  e_soul_drain:    { name:'魂吸収',       icon:'💜', power:18,  type:'magic',    target:'single', hits:1, animation:'dark',      healSelf:0.4, selfShieldPower:20 },
  e_iron_pound:    { name:'鉄拳',         icon:'👊', power:25, type:'physical', target:'single', hits:1, animation:'punch', selfShieldPower:30 },
  e_frost_blast:   { name:'霜撃',         icon:'🧊', power:18,  type:'magic',    target:'single', hits:1, animation:'ice', effect:'freeze', effectChance:1, effectTurns:1 },
  e_venom_coil:    { name:'毒の締め付け', icon:'🐍', power:14,  type:'physical', target:'single', hits:1, animation:'slash',     effect:'poison', effectChance:1, effectTurns:3 },
  e_abyss_slash:   { name:'深淵斬',       icon:'🌑', power:20, type:'magic',    target:'single', hits:1, animation:'dark', selfShieldPower:20 },
  e_plague_cloud:  { name:'疫病雲',       icon:'🎭', power:0,   type:'support',  target:'all',    effect:'poison', effectChance:1, effectTurns:2, animation:'dark' },
  e_shadow_strike: { name:'影打ち',       icon:'🌑', power:29, type:'physical', target:'single', hits:1, animation:'slash' },
  e_blood_art_2:   { name:'血鬼術改',     icon:'🩸', power:22, type:'magic',    target:'single', hits:1, animation:'dark' },
  e_earth_smash:   { name:'大地砕き',     icon:'🗻', power:19,  type:'physical', target:'all',    hits:1, animation:'slash' },
  e_void_drain:    { name:'虚無吸収',     icon:'👁️', power:17,  type:'magic',    target:'single', hits:1, animation:'dark',      healSelf:0.35, selfShieldPower:15 },
  e_demon_blade:   { name:'魔刃',         icon:'⚔️', power:22, type:'physical', target:'single', hits:1, animation:'slash' },
  e_cursed_slash:  { name:'呪斬',         icon:'💜', power:16,  type:'physical', target:'single', hits:1, animation:'dark',      effect:'curse', effectChance:1, effectTurns:2 },

  // ---- Charge skills: fire after chargeTurns, cancelled by defeat/stun (3) ----
  e_charge_cannon:   { name:'フルチャージ砲', icon:'🔋', power:60, type:'magic', target:'all', hits:1, animation:'beam',      noSpread:true, chargeTurns:1 },
  e_charge_eruption: { name:'大噴火',        icon:'🌋', power:78, type:'magic', target:'all', hits:1, animation:'explosion', noSpread:true, chargeTurns:1 },
  e_charge_abyss:    { name:'終焉の息吹',    icon:'🌀', power:69, type:'magic', target:'all', hits:1, animation:'dark',      noSpread:true, chargeTurns:1 },
  ...
  b_susanoo:         { name:'須佐能乎',             icon:'👁️', power:30, type:'magic',    target:'single', hits:1, animation:'dark' },
  ...
  b_mutsuki:         { name:'月読',                 icon:'🌙', power:24, type:'magic',    target:'single', hits:1, animation:'dark',  effect:'stun', effectChance:1, effectTurns:1 },
  b_meteor:          { name:'地爆天星',               icon:'☄️', power:38, type:'magic',    target:'all',    hits:1, animation:'explosion', noSpread:true, chargeTurns:1 },
  b_rinnegan:        { name:'輪廻眼引力',           icon:'🌀', power:22, type:'magic',    target:'single', effect:'def_down', effectChance:1, effectTurns:2, animation:'dark' },
  ...
  b_dark_all:        { name:'暗黒の波動',           icon:'🌑', power:26, type:'magic',    target:'all',    hits:1, animation:'dark' },
  ...
  b_collapsing_star: { name:'エナジー乱射',         icon:'⭐', power:30, type:'magic',    target:'all',    hits:1, animation:'explosion' },
  ...
  b_kaguya_byakugan:  { name:'白眼',       icon:'👁️', power:26, type:'magic',    target:'single', hits:1, animation:'beam' },
  ...
  b_kaguya_truth:     { name:'真実の求道玉',   icon:'⚫', power:33, type:'magic',    target:'single', hits:1, animation:'dark' },
  ...
  b_meruem_strike:    { name:'王の一撃',       icon:'👊', power:31, type:'physical', target:'single', hits:1, animation:'slash' },
  ...
  b_meruem_nen:       { name:'絶対王の腕',         icon:'🌑', power:35, type:'magic',    target:'single', hits:1, animation:'beam' },
  ...
  b_aizen_light:      { name:'黒棺',           icon:'🌑', power:30, type:'magic',    target:'single', hits:1, animation:'dark' },
  ...
  b_sat_shadow:     { name:'嫉妬の影',         icon:'🌑', power:24, type:'magic',    target:'single', hits:1, animation:'dark' },
  ...
  b_sat_jealousy:   { name:'嫉妬の嵐',        icon:'🌑', power:25, type:'magic',    target:'single', hits:1, animation:'dark',      effect:'stun', effectChance:1, effectTurns:1 },
  ...
  b_heath_holy:     { name:'神聖剣',           icon:'✝️', power:26, type:'magic',    target:'single', hits:1, animation:'beam' },
  ...
  b_heath_sword:    { name:'神聖剣連撃',       icon:'⚔️', power:31, type:'magic',    target:'single', hits:1, animation:'beam' },
  ...
  b_pucci_time:     { name:'時間加速',         icon:'⏩', power:27, type:'magic',    target:'all',    hits:1, animation:'beam' },
  ...
  mb_pain_chibaku:  { name:'地爆天星',         icon:'💥', power:28, type:'magic',    target:'all',    hits:1, animation:'explosion', noSpread:true },
  ...
  mb_jogo_max:      { name:'蓋棺鉄囲山',       icon:'💥', power:29, type:'magic',    target:'all',    hits:1, animation:'explosion', noSpread:true },
  ...
  mb_dabi_wall:     { name:'青白い炎の壁',     icon:'💥', power:29, type:'magic',    target:'all',    hits:1, animation:'explosion', noSpread:true },
  mb_beast_throw:   { name:'岩石投擲',         icon:'🦍', power:22, type:'physical', target:'all',    hits:1, animation:'slash' },
  ...
  mb_ros_all:       { name:'森羅万象・全開放',       icon:'💥', power:28, type:'magic',    target:'all',    hits:1, animation:'explosion', noSpread:true },
  ...
  mb_walp_cannon:   { name:'大砲一斉射撃',     icon:'💥', power:25, type:'magic',    target:'all',    hits:1, animation:'explosion' },
